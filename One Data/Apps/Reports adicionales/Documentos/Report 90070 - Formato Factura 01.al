report 90070 "Formato Factura 01"
{
    ...
    // </changelog>
    DefaultLayout = RDLC;
    RDLCLayout = './One Data/Apps/Reports adicionales/Documentos/RDLCLayout/Formato Factura 01.rdl';
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        dataitem("Sales Shipment Buffer"; Integer)
                        {
                            ...
                            trigger OnAfterGetRecord();
                            var
                                lf: report "Standard Sales - Invoice";
                            begin
                                IF Number = 1 THEN
